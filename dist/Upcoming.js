...
class Template {
    constructor() {
        ...
        this.template = templates['upcoming.html'] = template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
          ...
          return buffer + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.closed : depth0),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
            ...
            + "</td>\r\n                                                </tr>\r\n                                                <tr>\r\n                                                    <td colspan=\"2\"><input class=\"slider\" type='text' data-slider-min='0' data-slider-max='"
            + alias4(alias5(((stack1 = (depth0 != null ? depth0.delegates : depth0)) != null ? stack1.total : stack1), depth0))
            + "' data-slider-step='1' data-slider-value='"
            + alias4(alias5(((stack1 = (depth0 != null ? depth0.delegates : depth0)) != null ? stack1.half : stack1), depth0))
            + "' data-slider-tooltip='hide' data-state='"
            + alias4(((helper = (helper = helpers.abbr || (depth0 != null ? depth0.abbr : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"abbr","hash":{},"data":data}) : helper)))
            + "'/></td>\r\n                                                </tr>\r\n";
